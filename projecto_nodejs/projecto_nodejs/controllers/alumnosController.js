...
var controller = {
    ...
    alumno: function (req, res) {
        ...
        Alumnos.findOne({ n_lista: n_lista }).exec((err, alumno) => {
            if (err) return res.status(500).json({ status: 500, mensaje: err });
    ...
    update_alumno: function (req, res) {
        ...
        Alumnos.findOneAndUpdate({ n_lista: n_lista }, alumno_info_update, { new: true }, (err, alumnoUpdate) => {
    ...
    delete_alumno: function (req, res) {
        ...
        Alumnos.findOneAndRemove({ n_lista: n_lista }, (err, alumnoDelete) => {
